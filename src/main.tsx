      ...
      <div className="max-w-5xl mx-auto grid gap-6">
        ...
        <section className="text-xs text-slate-500">
          <ul className="list-disc ml-5 space-y-1">
            <li>Characters are pulled from D&D Beyond using the public character-service API you provided. Some character features that affect initiative aren’t auto-applied—set their initiative manually or use 🎲 with the shown Dex Mod.</li>
            <li>Monster initiative uses a simple roll: d20 + Dex Mod.</li>
            <li>LocalStorage keeps your roster and round/turn between reloads.</li>
          </ul>
        </section>
      </div>
    </div>
